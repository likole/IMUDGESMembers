...
public class MailUtil {
    ...
    public static Message createMimeMessage(Session session, String sendMail, String receiveMail, String content) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "IMUDGES MEMBERS MANAGEMENT", "UTF-8"));
        ...
        message.setContent("亲爱的用户,您好<br/><br/>请点击下面的链接完成注册：<br/><br/><a href='"+serverAddress+content+"'>"+serverAddress+content+"</a><br/><br/>如果链接无法点击，请复制上面的链接到您的浏览器地址栏打开<br/><br/>欢迎使用IMUDGES MEMBERS MANAGEMENT！<br/><br/>系统自动发送的邮件,请不要直接回复。<br/><br/>如果这不是您的操作，请忽略", "text/html;charset=UTF-8");
